# Contribute to Paid Memberships Pro - Extra Expiration Warning Emails
...
* Submit a ticket for your issue, assuming one does not already exist.
  * Raise it on our [Issue Tracker](https://github.com/strangerstudios/pmpro-extra-expiration-warning-emails/issues/new/choose)
...
* Make sure to pull in any "upstream" changes first.
	* Use `git remote add upstream https://github.com/strangerstudios/pmpro-extra-expiration-warning-emails.git` to set the upstream repo
